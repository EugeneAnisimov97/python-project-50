...
def generate_diff(file1, file2, formatter='stylish'):    # gendiff 'tests/fixtures/file1.json' 'tests/fixtures/file2.json' gendiff 'tests/fixtures/filepath1.yml' 'tests/fixtures/filepath2.yml'  # noqa: E501
